...
// encapsulated variables
    ...
    defaultOptions = {
        ...
        lang: {
            ...
            // invalidDate: '',
            decimalPoint: '.',
            numericSymbols: null, //otherwise by default ['k', 'M', 'G', 'T', 'P', 'E'], // SI prefixes used in axis labels
        ...
        credits: {
            enabled: false,
            text: 'shriramhousing.in',
            href: 'http://www.shriramhousing.in/',
            position: {
                align: 'right',
                x: -10,
                verticalAlign: 'bottom',
    ...
    Legend.prototype = {
        ...
        init: function (chart, options) {
            ...
            legend.padding = padding = pick(options.padding, 2);
            legend.initialItemX = padding;
            legend.initialItemY = padding - 5; // 5 is the number of pixels above the text
            legend.maxItemWidth = 0;
            legend.chart = chart;
            legend.itemHeight = 0;
            legend.symbolWidth = pick(options.symbolWidth, 15);
            legend.pages = [];
